...
<div class="s-wrap">
    ...
    <div class="t-i">
        <div class="row">
            ...
            <div class="col"><?php echo ($info["name"]); ?></div>
        </div>
        <div class="row">
            <div class="col">性别</div>
            <div class="col"><?php echo ($info["sex"]); ?></div>
        </div>
        <div class="row">
            <div class="col">家乡</div>
            <div class="col"><?php echo ($info["hometown"]); ?></div>
        </div>
        <div class="row">
            <div class="col">联系方式</div>
            <div class="col"><?php echo ($info["way"]); ?></div>
        </div>
        <div class="row">
            <div class="col">简介</div>
            <div class="col"><?php echo ($info["introduce"]); ?></div>
        </div>
    </div>
</div>
</body>
